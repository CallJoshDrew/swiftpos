let menu = [
    ...
    { id: 16, name: "Kono Mee", category: "Dish", price:8.00, image: "/konoMee.png", selection:true, choices: [{name: "Campur", price: 0.00}, {name: "Ayam Goreng", price: 0.00}, {name: "Sui Kau", price: 1.00}, {name: "Seafood", price: 2.00}, {name: "Udang", price: 4.00}]},
    { id: 17, name: "Goreng Kering", category: "Dish", price:9.00, image: "/gorengKering.png", selection:true, choices: [{name: "Campur", price: 0.00}, {name: "Ayam", price: 0.00}, {name: "Ayam Goreng", price: 1.00}, {name: "Seafood", price: 2.00}]},

    { id: 18, name: "Goreng Basah", category: "Dish", price:8.00, image: "/gorengBasah.png", selection:true, choices: [{name: "Campur", price: 0.00}, {name: "Ayam", price: 0.00}, {name: "Ayam Goreng", price: 1.00}, {name: "Seafood", price: 2.00}], meat: [{level:"Normal Meat", price: 0.00}, {level:"Extra Meat", price: 2.00}], addOn: [{type:"Normal Mee", price: 0.00},{type:"Extra Mee", price: 2.00}]},

    { id: 19, name: "Laksa", category: "Dish", price:10.0, image: "/laksa.png", selection:true, choices: [{name: "Campur", price: 0.00}, {name: "Ayam Goreng", price: 0.00}, {name: "Sui Kau", price: 0.00}, {name: "Seafood", price: 2.00}]},

    { id: 20, name: "Lo Mee", category: "Dish", price:10.0, image: "/loMee.png", selection:true, choices: [{name: "Campur", price: 0.00}, {name: "Ayam", price: 0.00}, {name: "Sui Kau", price: 0.00}, {name: "Seafood", price: 2.00}]},

    { id: 21, name: "Watan Hor", category: "Dish", price:10.00, image: "/watanHor.png", selection:true, choices: [{name: "Campur", price: 0.00},{name: "Ayam", price: 0.00}, {name: "Sui Kau", price: 0.00}, {name: "Seafood", price: 2.00}]},
    ...
    { id: 56, name: "Soft Drink", category: "Drinks", price:2.50, image: "/pandan.png", selection:true, choices: [{name: "Cola", price: 0.00},{name: "100%", price: 0.00}, {name: "Sasi", price: 0.00},{name: "Soy Milk", price: 0.00},{name: "F&N Zappel", price: 0.00},{name: "Chrysanthemum", price: 0.00}]},
    { id: 57, name: "Kopi O", category: "Drinks", price:1.80, image: "/pandan.png", selection:true, choices: [{name: "Hot", price: 0.00}, {name: "Cold", price: 2.50}]},
    { id: 58, name: "Pandan Soy Milk", category: "Drinks", price:1.80, image: "/pandan.png", selection:true, choices: [{name: "normal", price: 0.00}, {name: "No Sugar", price: 0.50}]},
    { id: 59, name: "Teh O", category: "Drinks", price:1.80, image: "/pandan.png", selection:true, choices: [{name: "Hot", price: 0.00},{name: "Cold", price: 0.70}]},
    { id: 60, name: "Chinese Teh", category: "Drinks", price:0.50, image: "/pandan.png", selection:true, choices: [{name: "Hot", price: 0.00},{name: "Cold", price: 0.00}]},
  ];
