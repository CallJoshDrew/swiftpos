...
export default function CartDetails({ cartItems, taxRate, setCartItems }) {
    ...
    <div className="py-10 w-2/6 flex-auto flex flex-col relative">
      <div className="fixed h-screen w-2/6 overflow-y-scroll pb-10 px-6">
        ...
        <div className="flex flex-col gap-4">
          {cartItems.map((item) => (
            <div key={item.id} className="flex flex-wrap border rounded-md p-2 shadow-sm">
              <Image
                src="/sample.png"
                alt="stew"
                width="50"
              ...
              />
              <div className="grow flex flex-col py-1 px-4 relative">
              ...
              <div className="flex justify-between px-2 py-1 bg-gray-200 rounded-md mt-2 w-full">
                ...
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  className="w-6 h-6 text-red-700 p-1"
