...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="bg-gray-100 w-5/6 min-h-screen flex flex-col items-center justify-center flex-auto gap-2 pt-10 px-10">
        <h1 className="text-4xl mb-8 text-green-800 font-bold">Welcome to our POS system</h1>
        <form onSubmit={handleSubmit} className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
          <div className="mb-4">
            <label className="block text-gray-700 text-md font-bold mb-2" htmlFor="availableCash">
                  ...
                  <div className="sm:flex sm:items-start">
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      <h3 className="text-lg leading-6 font-medium text-gray-900" id="modal-title">
                        Please confirm and make sure the info provided is accurate before proceed.
                      </h3>
                      <div className="mt-2">
